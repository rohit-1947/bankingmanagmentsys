		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				%>
					...
					<%
					if (String.valueOf(session.getAttribute("role")).equals("MANAGER")) {
					%>
					<li><a href="/Managerdashboard">HOME</a></li>
					<li  id="reg"><a>User <em class="fa fa-caret-down"></em></a>
					<ul>
					<li  id="ram"><a data-toggle="modal" data-target="#add-user-modal"
								data-ticket-type="premium-access">Add User</a></li>
					<li  id="ram"><a href="/ViewAllUsers">View Users</a></li>
					</ul></li>
					<li  id="reg"><a href="/ViewLoans">View Loans</a></li>
					<li  id="reg"><a>Tickets <em class="fa fa-caret-down"></em></a>
					<ul>
					<li  id="ram"><a href="/SolvedTickets">Solved Tickets</a></li>
					<li  id="ram"><a href="/PendingTickets">Pending Tickets</a></li>
					</ul></li>
					<li><a href="/getAllAccounts">Account</a></li>
					<li><a href="/getAllTransactions">Transaction</a></li>
					<li><a href="/ManagerProfile">PROFILE</a></li>
					<li><a
					...
					<li id="reg"><a href="/showall">MANAGE USERS<em class="fa fa-caret-down"></em></a>
					<ul>
					<li id="ram"><a data-toggle="modal" data-target="#add-user-modal"
			...
			data-ticket-type="premium-access">Add Managers</a></li>
					...
					<li id="reg"><a>Tickets<a>User<em class="fa fa-caret-down"></em></a>
					<ul>
					<li id="ram"><a href="/SolvedTickets">Solved Tickets</a></li>
					<li id="ram"><a href="/PendingTickets">Pending Tickets</a></li>
					</ul></li>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h2 align="center" modal-title">ADD USER</h2>
